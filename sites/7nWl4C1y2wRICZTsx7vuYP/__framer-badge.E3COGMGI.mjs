    ...
    a("a", {
      ...
      children: a(t, {
        ...
        onClick: (o) => {
          ...
          (o.preventDefault(),
            l.open(
              `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent((C = l) === null || C === void 0 || (r = C.location) === null || r === void 0 ? void 0 : r.origin)}`,
            ));
        },
        style: { ...e.style, cursor: "pointer" },
      }),
    });
}
var j = H(d.div),
  ...
  O = "framer-TLVk2",
  B = { AN4QiK4rL: "framer-v-17nhh09", HK2sXlagE: "framer-v-n0ccwk" };
function x(t, ...e) {
  let o = {};
  return (e?.forEach((r) => r && Object.assign(o, t[r])), o);
}
var z = { damping: 60, delay: 0, mass: 1, stiffness: 500, type: "spring" },
  G = (t, e) => `translate(-50%, -50%) ${e}`,
  J = ({ value: t, children: e }) => {
    let o = v(f),
      r = t ?? o.transition,
      C = y(() => ({ ...o, transition: r }), [JSON.stringify(r)]);
    return a(f.Provider, { value: C, children: e });
  },
  $ = d(h),
  q = { Dark: "AN4QiK4rL", Light: "HK2sXlagE" },
  Y = ({ height: t, id: e, width: o, ...r }) => {
    var C, n;
    return {
      ...r,
      variant:
        (n = (C = q[r.variant]) !== null && C !== void 0 ? C : r.variant) !==
          null && n !== void 0
          ? n
          : "HK2sXlagE",
    };
        ...
        children: a(J, {
          ...
          children: a(j, {
            ...
            style: {
              ...
              boxShadow:
                "0px 0.6369534988189116px 1.1465162978740409px -1.125px rgba(0, 0, 0, 0.26045), 0px 1.9316049144836143px 3.4768888460705054px -2.25px rgba(0, 0, 0, 0.24103), 0px 5.106122817187569px 9.191021070937623px -3.375px rgba(0, 0, 0, 0.19341), 0px 16px 28.799999999999997px -4.5px rgba(0, 0, 0, 0.03)",
              ...C,
            },
            variants: {
              AN4QiK4rL: {
                ...
                boxShadow:
                  "0.3184767494094558px 0.6369534988189116px 0.7121356609327092px -0.9375px rgba(0, 0, 0, 0.51107), 0.9658024572418071px 1.9316049144836143px 2.159599947229015px -1.875px rgba(0, 0, 0, 0.48275), 2.5530614085937846px 5.106122817187569px 5.708818860347068px -2.8125px rgba(0, 0, 0, 0.4133), 8px 16px 17.88854381999832px -3.75px rgba(0, 0, 0, 0.175)",
              },
            },
            ...x(
              { AN4QiK4rL: { "data-border": !0, "data-framer-name": "Dark" } },
              m,
              c,
            ),
            children: V(d.div, {
              ...
              children: [
                ...
                a(g, {
                  ...
                  description:
                    "Made in Framer. The professional custom website design builder for startups, designers and agencies.",
                  layout: "position",
                  layoutDependency: L,
  ...
  r1 = [
    ...
    ".framer-TLVk2 .framer-19yaanm { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; left: 50%; overflow: visible; padding: 0px; position: absolute; top: 50%; width: min-content; }",
    ".framer-TLVk2 .framer-tmnpxq { flex: none; height: 16px; position: relative; width: 11px; z-index: 2; }",
    ".framer-TLVk2 .framer-1v3cvgh { flex: none; height: 11px; position: relative; width: 92px; }",
  ...
  m1 = s;
s.displayName = "Badge";
s.defaultProps = { height: 36, width: 142 };
_(s, {
  variant: {
...
D(s, [{ explicitInter: !0, fonts: [] }], { supportsExplicitInterCodegen: !0 });
var c1 = {
  exports: {
    ...
    default: {
      ...
      annotations: {
        ...
        framerCanvasComponentVariantDetails:
          '{"propertyName":"variant","data":{"default":{"layout":["fixed","fixed"]},"AN4QiK4rL":{"layout":["fixed","fixed"]}}}',
...
//# sourceMappingURL=__framer-badge.E3COGMGI.mjs.map
