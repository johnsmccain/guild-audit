...
function awaitRefCallback(element, controller) {
    let refCallbackResolve: (node: HTMLElement) => void
    ...
    let current: HTMLElement | null = element.current
    ...
    effectsOptions: {
        ...
        controls: {
            ...
            playOffscreen: {
                ...
                disabledTitle: "Pause",
                defaultValue:
                    Slideshow.defaultProps.effectsOptions.playOffscreen,
            },
        },
    },
    alignment: {
...
const Dot = memo(function Dot({
    ...
    const bottom =
        !isHorizontal && index !== total - 1 ? inlinePadding : padding
