...
type IconStyle = "TwoTone" | "Sharp" | "Rounded" | "Outlined" | "Filled"
...
export interface IconProps {
    ...
    iconSearch?: string
    iconSelection?: keyof typeof icons
    onTap?: any
    onClick?: any
    onMouseEnter?: any
    onMouseLeave?: any
...
const styleOptionPropKeys = Object.keys(styleKeyOptions).map(
...
export function Icon(props: IconProps) {
    ...
    async function importModule() {
        ...
        try {
            ...
            const iconModuleUrl = `${moduleBaseUrl}${iconKey}${style}.js@0.0.32`
            // console.log(iconModuleUrl)
...
Icon.defaultProps = {
    width: 24,
    height: 24,
    iconSelection: "Home" as keyof typeof icons,
    iconSearch: "Home",
    color: "#66F",
    selectByList: true,
    weight: "Filled" as IconStyle,
    mirrored: false,
}

function hideStyleOptions(props: any, styleOptions: string) {
...
addPropertyControls(Icon, {
    ...
    iconSelection: {
        ...
        options: iconKeys as Array<keyof typeof icons>,
