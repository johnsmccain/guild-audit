(function(k, O) {
    ...
    var z = (k, O, p) => (qt(k, typeof O != "symbol" ? O + "" : O, p), p);
    let O = 0;
    ...
    let Oe = class {
        constructor(e) {
            if (this.type = "Scene", !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
    ...
    class We {
        constructor(e, t, s) {
            if (this.type = "Uniforms", !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                L(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
...
`).replace(/\n/g, "");
    ...
    class pe {
        constructor(e, {
            ...
            if (this.type = "Program", !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                L(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
            this.renderer = e, this.gl = this.renderer.gl, this.parent = t, this.defaultVsCode = this.parent.type === "Plane" ? Be : Ge, this.defaultFsCode = this.parent.type === "Plane" ? He : je, s ? this.vsCode = s : (!this.renderer.production && this.parent.type === "Plane" && p(this.parent.type + ": No vertex shader provided, will use a default one"), this.vsCode = this.defaultVsCode), i ? this.fsCode = i : (this.renderer.production || p(this.parent.type + ": No fragment shader provided, will use a default one"), this.fsCode = this.defaultFsCode), this.compiled = !0, this.setupProgram()
        }
        createShader(e, t) {
...
`, this.gl.getShaderInfoLog(s)), L(a), p(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t)
            }
            return s
        }
        useNewShaders() {
        ...
        createUniforms(e) {
            this.uniformsManager = new We(this.renderer, this.program, e), this.setUniforms()
        }
        setUniforms() {
    ...
    class Xe {
        constructor(e, {
            ...
            if (this.type = "Geometry", !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                L(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
    ...
    class B {
        ...
        getInverse() {
            ...
            return C ? (C = 1 / C, s[0] = (l * X - d * j + c * G) * C, s[1] = (a * j - r * X - h * G) * C, s[2] = (y * E - g * A + _ * T) * C, s[3] = (m * A - u * E - x * T) * C, s[4] = (d * I - o * X - c * S) * C, s[5] = (i * X - a * I + h * S) * C, s[6] = (g * P - b * E - _ * w) * C, s[7] = (f * E - m * P + x * w) * C, s[8] = (o * j - l * I + c * M) * C, s[9] = (r * I - i * j - h * M) * C, s[10] = (b * A - y * P + _ * v) * C, s[11] = (u * P - f * A - x * v) * C, s[12] = (l * S - o * G - d * M) * C, s[13] = (i * G - r * S + a * M) * C, s[14] = (y * w - b * T - g * v) * C, s[15] = (f * T - u * w + m * v) * C, t) : null
        }
        scale(e) {
            let t = this.elements;
        ...
        compose(e, t, s) {
            ...
            const r = t.elements[0],
                ...
                P = s.y,
                T = s.z;
            return i[0] = (1 - (x + y)) * w, i[1] = (u + v) * w, i[2] = (m - _) * w, i[3] = 0, i[4] = (u - v) * P, i[5] = (1 - (f + y)) * P, i[6] = (b + g) * P, i[7] = 0, i[8] = (m + _) * T, i[9] = (b - g) * T, i[10] = (1 - (f + x)) * T, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
        }
        composeFromOrigin(e, t, s, i) {
            ...
            const a = t.elements[0],
                ...
                Fe = (y - _) * A,
                Le = (1 - (u + b)) * A;
            return r[0] = I, r[1] = G, r[2] = j, r[3] = 0, r[4] = X, r[5] = C, r[6] = Ce, r[7] = 0, r[8] = Ie, r[9] = Fe, r[10] = Le, r[11] = 0, r[12] = e.x + E - (I * E + X * M + Ie * S), r[13] = e.y + M - (G * E + C * M + Fe * S), r[14] = e.z + S - (j * E + Ce * M + Le * S), r[15] = 1, this
        }
    }
    class F {
        constructor(e = 0, t = e) {
    ...
    class q {
        constructor(e, {
            ...
            if (this.type = "Texture", e = e && e.renderer || e, !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
            ...
            if (this.renderer = e, this.gl = this.renderer.gl, this.uuid = he(), this._globalParameters = {
                    ...
                    width: 1,
                    height: 1
                }, this.scale = new F(1), this.scale.onChange(() => this.resize()), this.offset = new F, this.offset.onChange(() => this.resize()), this._loader = i, this._sourceLoaded = !1, this._uploaded = !1, this._willUpdate = !1, this.shouldUpdate = !1, this._forceUpdate = !1, this.userData = {}, this._canDraw = !1, s) {
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
        ...
        _updateTextureMatrix(e) {
            ...
            t.x /= this.scale.x, t.y /= this.scale.y, this._textureMatrix.matrix = qe.setFromArray([t.x, 0, 0, 0, 0, t.y, 0, 0, 0, 0, 1, 0, (1 - t.x) / 2 + this.offset.x, (1 - t.y) / 2 + this.offset.y, 0, 1]), this._updateMatrixUniform()
        }
    ...
    class $e {
        constructor(e, t = "anonymous") {
            if (this.type = "TextureLoader", e = e && e.renderer || e, !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                L(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
    ...
    class Ze {
        constructor(e, t = "Mesh", {
            ...
            if (this.type = t, e = e && e.renderer || e, (!e || e.type !== "Renderer") && (L(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e), setTimeout(() => {
                    this._onErrorCallback && this._onErrorCallback()
                }, 0)), this.renderer = e, this.gl = this.renderer.gl, !this.gl) {
                this.renderer.production || L(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"), setTimeout(() => {
                    this._onErrorCallback && this._onErrorCallback()
                }, 0);
                return
            }
            this._canDraw = !1, this.renderOrder = d, this._depthTest = c, this.cullFace = f, this.cullFace !== "back" && this.cullFace !== "front" && this.cullFace !== "none" && (this.cullFace = "back"), this.textures = [], this._texturesOptions = Object.assign({
                ...
                magFilter: this.gl.LINEAR
            }, u), this.crossOrigin = m, !r && s && document.getElementById(s) && (r = document.getElementById(s).innerHTML), !a && i && document.getElementById(i) && (a = document.getElementById(i).innerHTML), this._initMesh(), o = parseInt(o), l = parseInt(l), this._geometry = new Xe(this.renderer, {
                width: o,
                height: l
        ...
        _initMesh() {
            this.uuid = he(), this.loader = new Qe(this.renderer, this, {
                sourcesLoaded: 0,
                initSourcesToLoad: 0,
                complete: !1,
                onComplete: () => {
...
`, r), i && i(r, a)
    ...
    class et {
        constructor({
            ...
            this.position = new R, this.projectionMatrix = new B, this.worldMatrix = new B, this.viewMatrix = new B, this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, a)
        }
        setFov(e) {
    ...
    class _e extends Ke {
        constructor(e, t, {
            ...
            super(e, t, "Plane", {
                ...
                texturesOptions: u,
                crossOrigin: m
            }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = x, this._shouldDraw = !0, this.visible = b, this._transparent = y, this.drawCheckMargins = g, this.autoloadSources = _, this.watchScroll = v, this._updateMVMatrix = !1, this.camera = new et({
                fov: w,
        ...
        _initTransformValues() {
            this.rotation = new R, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new te, this.relativeTranslation = new R, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new R, this.scale = new R(1), this.scale.onChange(() => {
                this.scale.z = 1, this._applyScale()
            }), this.transformOrigin = new R(.5, .5, 0), this.transformOrigin.onChange(() => {
        ...
        setScale(e) {
            ...
            e.sanitizeNaNValuesWith(this.scale).max(tt.set(.001, .001)), (e.x !== this.scale.x || e.y !== this.scale.y) && (this.scale.set(e.x, e.y, 1), this._applyScale())
        }
        _applyScale() {
            for (let e = 0; e < this.textures.length; e++) this.textures[e].resize();
        ...
        mouseToPlaneCoords(e) {
            if (me.setAxisOrder(this.quaternion.axisOrder), me.equals(this.quaternion) && ot.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e); {
                const t = {
    ...
    class le {
        constructor(e, {
            ...
            if (this.type = "RenderTarget", e = e && e.renderer || e, !e || e.type !== "Renderer") L(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                e.production || L(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined");
                return
            }
    ...
    const _t = (n, e) => {
            ...
            for (let r = 1; r < s; r++) {
                ...
                a <= e / 2 ? i < e / 2 ? i += a : (t.push([se(n[r - 1][0], n[r][0], .5), se(n[r - 1][1], n[r][1], .5)]), i = 0) : t.push([se(n[r - 1][0], n[r][0], .5), se(n[r - 1][1], n[r][1], .5)])
            }
            return t.push(n[s]), t
        },
        xt = (n, e) => {
            ...
            function r(a) {
                let h = 1,
                    o = 0;
                for (; n[h + 1] && o < a * e;) o += xe(n[h][0], n[h][1], n[h - 1][0], n[h - 1][1]), h++;
                return n[h]
            }
            for (let a = 0; a < s; a++) {
                const h = r(a),
    ...
    (function(n) {
        ...
        function r(h, o, l, d, c, f, u) {
            o === void 0 && (o = [
                [0, "#fff"],
                [1, "#fff"]
            ]), l === void 0 && (l = 0), d === void 0 && (d = 0), c === void 0 && (c = 0), f === void 0 && (f = 2 * Math.PI), u === void 0 && (u = !1);
            ...
            y.translate(l, d);
            for (var v = 2 * Math.PI * (_ + 20) / 360, w = new i.default(o, x - m + 1), P = m; P <= x; P++) y.save(), y.rotate((u ? -1 : 1) * (Math.PI * P) / 180), y.beginPath(), y.moveTo(0, 0), y.lineTo(_, -2 * v), y.lineTo(_, 0), y.fillStyle = w.getColor(P - m), y.fill(), y.closePath(), y.restore();
            var T = document.createElement("canvas");
            T.width = h.canvas.width, T.height = h.canvas.height;
            var A = T.getContext("2d");
            return A.beginPath(), A.arc(l, d, _, c, f, u), A.lineTo(l, d), A.closePath(), A.fillStyle = A.createPattern(b, "no-repeat"), A.fill(), h.createPattern(T, "no-repeat")
        }
    ...
    let ie, re, de;
    typeof document.hidden < "u" ? (ie = "hidden", re = "visibilitychange") : typeof document.msHidden < "u" ? (ie = "msHidden", re = "msvisibilitychange") : typeof document.webkitHidden < "u" && (ie = "webkitHidden", re = "webkitvisibilitychange");
    const bt = {
        NORMAL: "Normal",
        ADD: "Add",
        SUBTRACT: "Subtract",
    ...
    function ae() {
        ...
        const n = D.filter(t => t.getAnimatingEffects().length),
            e = t => {
                ...
                }), s.length ? (Vt(), de || Ee(), s.forEach(i => {
                    i.curtain && t - i.lastTime >= i.frameDuration && (i.curtain.render(), i.lastTime = t)
    ...
    class At {
        constructor({
            ...
            this.prop = e, this.value = t, this.transition = s, this.complete = !1, this.progress = 0, this.initialStateSet = !1, this.uniformData = i, typeof this.value == "object" && (this.value.type === "Vec2" ? this.value = new F(this.value._x, this.value._y) : this.value.type === "Vec3" && (this.value = new R(this.value._x, this.value._y, this.value._z)))
        }
        cloneVector(e) {
            let t;
            return e.type === "Vec2" ? (t = new F(e._x, e._y), this.prop === "pos" && (t.y = 1 - t.y)) : e.type === "Vec3" && (t = new R(e._x, e._y, e._z)), t
        }
        initializeState(e, t) {
            if (t !== void 0 && (typeof t == "object" ? (this.endVal = this.cloneVector(t), this.startVal = this.cloneVector(this.value)) : this.endVal = t), e) {
                if (typeof this.value == "object") {
                    let r;
                    this.value.type === "Vec2" ? r = new F(this.value._x, this.value._y) : this.value.type === "Vec3" && (r = new R(this.value._x, this.value._y, this.value._z)), e.value = r
        ...
        updateEffect(e) {
            ...
            if (h > 0 && h <= 1) {
                let l = r(h);
                t ? (i.value.x = H(o.x, this.endVal.x, l), this.prop === "pos" ? i.value.y = H(1 - o.y, this.endVal.y, l) : i.value.y = H(o.y, this.endVal.y, l), o.type === "Vec3" && (i.value.z = H(o.z, this.endVal.z, l))) : i.value = H(o, this.endVal, l)
    ...
    class Ct {
        constructor({
            ...
            z(this, "type", "scroll");
            this.prop = e, this.value = t, this.progress = 0, this.momentum = r, this.range = s, this.offset = i, this.uniformData = a, typeof this.value == "object" && (this.value.type === "Vec2" ? this.value = new F(this.value._x, this.value._y) : this.value.type === "Vec3" && (this.value = new R(this.value._x, this.value._y, this.value._z)))
        }
        package() {
            let e = {
                id: this.id,
        ...
        updateEffect(e, t, {
            ...
            return this.lastTick !== void 0 && (u = Q(u, this.lastTick, this.momentum * 2)), r ? (a.value.x = H(this.startVal.x, f.x, u), this.prop === "pos" ? a.value.y = H(1 - this.startVal.y, f.y, u) : a.value.y = H(this.startVal.y, f.y, u), this.startVal.type === "Vec3" && (a.value.z = H(this.startVal.z, f.z, u))) : a.value = H(this.startVal, f, u), this.lastTick = u, !0
        }
    }
    class we {
        constructor(e, t) {
            ...
            this.visible = e.visible !== void 0 ? e.visible : !e.hidden || !0, this.locked = e.locked || !1, this.aspectRatio = e.aspectRatio || 1, this.local.sceneId = t, this.local.id = Pe()
        }
        state() {
    ...
    class It extends ne {
        ...
        unpackage() {
            return this.coords = N(this.coords), this.fill = N(this.fill), this.effects = N(this.effects), this.coords.length > 3 ? this.coordsHiRes = ye(this.coords, this.size) : this.coordsHiRes = this.coords, this
        }
        interpolatePath() {
    ...
    class Ft extends ne {
        ...
        render() {
            ...
            if (this.local.ctx.beginPath(), this.type === "rectangle") {
                ...
                if (t.length) {
                    ...
                    for (let d = 0; d < t.length; d++) {
                        const [c, f] = t[d], [u, m] = t[(d + 1) % t.length], x = (d + 1) * Math.PI / 2 + a, [b, y] = r(i, 0, x);
                        let g = l[d];
            ...
            this.local.ctx.fillStyle = be(this.local.ctx, this, t), this.local.ctx.clearRect(0, 0, this.state().canvasWidth, this.state().canvasHeight), this.local.ctx.fill()
        }
    }
    class Te extends we {
        constructor(t, s, i) {
        ...
        unpackage() {
            ...
            for (let t in this) this[t] && this[t].type && (this[t].type === "Vec2" ? this[t] = new F(this[t]._x, this[t]._y) : this[t].type === "Vec3" && (this[t] = new R(this[t]._x, this[t]._y, this[t]._z)));
            return this
        }
        getParent() {
    ...
    class Dt extends ne {
        constructor(t, s, i, r) {
            ...
            if (this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), Rt(this, r.element), Object.keys(t).length && (this.createLocalCanvas(), requestAnimationFrame(() => {
                    this.coords = [
                        [-2, 0],
                        [-2 + this.width, 0],
        ...
        render() {
            ...
            a = Math.max(a, f), this.local.ctx.save(), this.local.ctx.translate(s + a / 2, i + h / 2), this.local.ctx.rotate(this.rotation * 360 * Math.PI / 180), this.local.ctx.translate(-(s + a / 2), -(i + h / 2)), this.textAlign === "center" && (s += a / 2), this.textAlign === "right" && (s += a), this.local.ctx.fillStyle = be(this.local.ctx, this, this.coords);
            const u = (g, _, v, w, P, T, A) => {
                    ...
                    if (T === "center" ? M = v + (A - E) / 2 - A / 2 : M = v, T === "right")
                        for (let S = _.length - 1; S >= 0; S--) {
                            ...
                            for (let S = 0; S < _.length; S++) g.fillText(_[S], M, w), M += g.measureText(_[S]).width + P
                },
                m = (g, _) => {
                    let v = i + l * _ + l / 2 + o / 3;
...
`) : [""];
            let b = x.length;
            const y = (g, _, v) => _.split("").reduce((P, T, A) => (P += g.measureText(T).width, A < _.length - 1 && (P += v), P), 0);
            for (let g = 0; g < b; g++) {
                let _ = "",
                    v = x[g].split(/(\s|\n)/);
...
` && x.push(P);
                            ...
                            for (; E.length > 0;) {
                                let S = "";
                                for (let I = 0; I < E.length && (this.local.ctx.measureText(S + E[I]).width <= a || I == 0); I++) S += E[I];
    ...
    function Vt() {
        D.forEach(n => {
            n.isInView && n.curtain.planes.find(e => e.uniforms.mousePos) && (ce() && n.interactivity && n.interactivity.mouse && n.interactivity.mouse.disableMobile || (n.mouse.pos.x = n.mouse.movePos.x, n.mouse.pos.y = n.mouse.movePos.y, n.mouse.lastPos.x = n.mouse.pos.x, n.mouse.lastPos.y = n.mouse.pos.y))
        })
    }
    let Se;

    function Me(n) {
        Ee(), de = !0, clearTimeout(Se), Se = setTimeout(() => {
            de = !1
        }, 16), D.filter(e => e.isInView).forEach(e => {
            let t = e.bbox,
                s, i;
    ...
    function Ee() {
        D.filter(n => n.isInView && n.mouse.recordTrail).forEach(n => {
            n.mouse.trail.unshift([n.mouse.pos.x / (n.bbox.width * .5), 1 - n.mouse.pos.y / (n.bbox.height * .5)]), n.mouse.trail.length > 100 && n.mouse.trail.pop()
        })
    }
    const D = [];
    class Nt {
        constructor(e) {
            this.id = e.id, this.projectId = e.projectId, this.canvasWidth = e.width || e.element.offsetWidth || window.innerWidth, this.canvasHeight = e.height || e.element.offsetHeight || window.innerHeight, this.curtain = void 0, this.curtainRafId = void 0, this.dpi = +e.dpi || Math.min(1.5, window.devicePixelRatio), this.element = e.element, this.fps = e.fps || 60, this.name = e.name, this.frameDuration = Math.floor(1e3 / (e.fps || 60)), this.layers = e.layers, this.initialized = !1, this.lasTick = null, this.isInView = !1, this.lastTime = 0, this.rendering = !1, this.bbox = {}, this.interactivity = {
                mouse: {
                    disableMobile: !1
                }
            }, this.mouse = {
            ...
            }, this.renderingScale = e.renderingScale || 1, this.scale = e.scale || 1, this.size = "Square", this.split = !1, this.versionId = "", e.width && e.height && (this.element.style.width = e.width + "px", this.element.style.height = e.height + "px"), this.bbox = this.element.getBoundingClientRect(), this.createCurtains(), this.setCanvasScale(), this.setVisibilityState()
        }
        setCanvasScale() {
        ...
        getSplitOrderedItems() {
            ...
            if (s) {
                ...
                for (; s && !$(s) && !r && !a;) t++, s = e[t], s && (i = s.parentLayer ? s.getParent() : null, r = i && $(i), a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(h => $(h)).length);
                return {
        ...
        createPingPongPlane(e, t, s) {
            ...
            const r = new pt(this.curtain, this.curtain.container, i),
                a = e.getParent();
            if (r) return r.userData.id = e.local.id, r.userData.pingpong = !0, r.setRenderOrder(t), this.setInitialEffectPlaneUniforms(r, e, a, s), r.onReady(() => {
        ...
        handleChildEffectPlane(e, t, s) {
            ...
            f && (i.userData.textureLoaded = !1, i.loadImage(f.src, {
                sampler: f.sampler
            }, u => {
                i.userData.textureLoaded = !0, this.curtain.render()
            }))
        ...
        handleStateEffects(e, t) {
            if (this.isInView && !e.userData.createdAt && (e.userData.createdAt = performance.now()), !t.states || ![...t.states.appear, ...t.states.scroll].length) return !1;
        ...
        setElementPlaneUniforms(e, t) {
            ...
            if (e.uniforms.mousePos) {
                ...
                if (t.mouseMomentum) {
                    ...
                    r = Q(r, h, t.mouseMomentum * 2), a = Q(a, o, t.mouseMomentum * 2), t.local.lastMousePos.x = r / s, t.local.lastMousePos.y = 1 - a / i
                }
        ...
        setEffectPlaneUniforms(e, t) {
            ...
            if (e.uniforms.previousMousePos)
                ...
                } else e.uniforms.previousMousePos.value.x = e.uniforms.mousePos.value.x, e.uniforms.previousMousePos.value.y = e.uniforms.mousePos.value.y;
    ...
    function Bt() {
        window.addEventListener("mousemove", Me), window.addEventListener("touchmove", Me), window.addEventListener("scroll", Ut), window.addEventListener("routeChange", St), ce() || window.addEventListener("resize", ve(kt, 50)), document.addEventListener(re, Ot, !1)
    }
    ...
    function Ae(n) {
        ...
        return new Promise((s, i) => {
            jt(e, t, n.filePath, i).then(r => {
                ...
                wt(l.filter(c => c.layerType === "text")), Tt(l.filter(c => c.layerType === "text"));
                const d = new Nt({
                    id: o,
                    fps: n.fps || a.fps || 60,
                    dpi: n.dpi,
    ...
    function Xt() {
        return new Promise((n, e) => {
            ...
            [...t].filter(s => !s.getAttribute("data-us-initialized")).forEach((s, i) => {
                ...
                s.setAttribute("data-us-initialized", !0), Ae({
                    projectId: r,
                    filePath: a,
                    element: s,
                    dpi: +h,
    ...
    Bt(), k.addScene = Ae, k.destroy = Gt, k.init = Xt, Object.defineProperty(k, Symbol.toStringTag, {
        value: "Module"
    })
});